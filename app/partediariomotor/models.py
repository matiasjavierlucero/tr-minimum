...
class Partediariomotor (db.Model):
    idPartediariomotor = db.Column(db.Integer, primary_key=True)
    idPlantaequipo = db.Column(db.Integer, db.ForeignKey('plantaequipo.idPlantaequipo'), nullable=False)
    gasoilPartediariomotor=db.Column(db.Float, nullable=False)
    ...
    def __init__(self,idPlantaequipo,gasoilPartediariomotor,idParteoperario):

        self.idPlantaequipo=idPlantaequipo
        self.gasoilPartediariomotor=gasoilPartediariomotor
